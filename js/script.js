...
const members = {
    ...
    serviceBill     :20,
    othersBill      :0,
    runningMonth    :"December-25",
    previousMonth   :"November-25", // new addDecember link https://grabify.link/P0IBKC
    upComingMonth   :"January 1,2026",
    runningMealRate :61,
...
//Continue for mass calculating {"04/08/25-Cash":4550}    
    "01922362569":{
        ...
        payment             :{"10/12/25-Cash":2000,"28/12/25-DBBL":1000,"30/12/25-Cash":300,"31/12/25-DBBL":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :2790,
        running_paid    :3800,
        running_meal    :26,
        // method 
        preMonth,
    ...
    "01797816501":{
        ...
        post_payable        :3239,
        previous_paid       :5200,
        previous_dining_cost:2088,
        payment             :{"10/12/25-Cash":4000,"25/12/25-Cash":1000},
        // running month{"04/08/25-Cash":4550}
        stay_cost       :2300,
        garage_cost     :0,
        running_payable :3087,
        running_paid    :5000,
        running_meal    :27,
        // method calling
        preMonth,
    ...
    "01581515641":{//01644377150
        ...
        payment             :{"06/12/25-Cash":2000,"13/12/25-Cash":3500,"19/12/25-Cash":1500,"27/12/25-Cash":500},
        // running month
        stay_cost       :3250,
        garage_cost     :0,
        running_payable :5558,
        running_paid    :7500,
        running_meal    :42,
        // method calling
        preMonth,
    ...
    "01537664564":{
        ...
        previous_paid       :6500,
        previous_dining_cost:2900,
        payment             :{"01/12/25-Cash":3000,"15/12/25-Cash":3200},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
    ...
    "01909752631":{
        ...
        previous_paid       :5000,
        previous_dining_cost:1450,
        payment             :{"07/12/25-Cash":4000,"17/12/25-Cash":3500,"28/12/25-Cash":500},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :3629,
        running_paid    :5000,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01934147404":{
        ...
        post_payable        :4500,
        previous_paid       :6000,
        previous_dining_cost:1740,
        payment             :{"01/12/25-Cash":5000,"15/12/25-Cash":900},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
	...
	"01639523533":{
        ...
        previous_paid       :4700,
        previous_dining_cost:1450,
        payment             :{"06/12/25-Cash":4000,"15/12/25-Cash":2000},
        // running month {"01/07/24-Cash":500}
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4241,
        running_paid    :6000,
        running_meal    :26,
        // method calling
        preMonth,
    ...
    "01920056090":{
        ...
        previous_paid       :3000,
        previous_dining_cost:1450,
        payment             :{"09/12/25-Cash":1500,"11/12/25-Cash":2000,"14/12/25-Cash":500,"19/12/25-Cash":2000},
        // running month
        stay_cost       :2400,
        garage_cost     :0,
	...
	"01821245430":{
        ...
        previous_paid       :3000,
        previous_dining_cost:2900,
        payment             :{"13/12/25-Cash":1000,"15/12/25-Cash":1000},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :1865,
        running_paid    :2000,
        running_meal    :41,
        // method calling
        preMonth,
